...
const OPTIONS = [
  ['private', 'Private', 'M5 8V6a3 3 0 1 1 6 0v2h1v6H4V8h1zm2-2a1 1 0 1 1 2 0v2H7V6z'],
  ['unlisted', 'Unlisted', 'M6 3a3 3 0 0 0-3 3v1h2V6a1 1 0 1 1 2 0v1h2V6a3 3 0 0 0-3-3zm-3 6h10v5H3V9z'],
  ['listed', 'Listed', 'M8 2a6 6 0 1 0 0 12A6 6 0 0 0 8 2zM3.5 8a4.5 4.5 0 0 1 9 0 4.5 4.5 0 0 1-9 0z'],
] as const
