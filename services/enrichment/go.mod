...
replace github.com/levonn-dev/vgkeep/libs/go/mongokit => ../../libs/go/mongokit

replace github.com/levonn-dev/vgkeep/libs/go/mongotest => ../../libs/go/mongotest
...
require (
	...
	github.com/levonn-dev/vgkeep/libs/go/mongokit v0.0.0-00010101000000-000000000000
	github.com/levonn-dev/vgkeep/libs/go/mongotest v0.0.0-00010101000000-000000000000
