...
- [collection.md](collection.md) - collection service: user collections
  and read-time value composition; telemetry reference, dashboard
  vg-collection, failure triage, resnapshot, normalize-platforms and
  entry rematch levers
- [enrichment.md](enrichment.md) - enrichment service: catalog and
  pricing quarantine, providers and stub modes, the catalog refresh;
  telemetry reference, dashboard vg-enrichment, moderation levers
